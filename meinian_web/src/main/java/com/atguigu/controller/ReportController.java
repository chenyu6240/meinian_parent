...
public class ReportController {
    ...
    public void exportBusinessReport(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            e.printStackTrace();
            request.getRequestDispatcher("/pages/downloadError.html").forward(request,response);
        }
    ...
    public Result getMemberReport() {
        try {
            ...
            List<String> monthsOutput = new ArrayList<>();
            ...
            for (int i = 0; i < 12; i++) {
                ...
                months.add(month);
                String monthOutput = sdf.format(month);
                monthsOutput.add(monthOutput);
